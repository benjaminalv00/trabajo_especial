...
for archivo in archivos:
    ...
    crs = ccrs.Geostationary(
        central_longitude=lon_cen, satellite_height=altura
...
img1 = axs[0].imshow(im_rec, vmin=-100.0, vmax=30.0, cmap="Greys")
...
img2 = ax2.imshow(
    im_rec, transform=crs, extent=img_extent, vmin=-100.0, vmax=30.0, cmap="Greys"
)
fig.colorbar(
    img2,
    ax=ax2,
